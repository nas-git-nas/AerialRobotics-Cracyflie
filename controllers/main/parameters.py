...
class Parameters():
    ...
    def __init__(self):
        ...
        self.path_first_point = (3.0,0.5) # (3.9,1.5) first point to fly to
        ...
        self.explore_speed_min = 0.005 # in meters/seconds, minimum speed to keep position while exploring
        self.explore_yaw_speed = 20.0 #0.1 # constant yaw speed when searching
        ...
        self.land_point_reached_dist = 0.08
